  ...
  })(
    {
        ...
        function (b, c, d) {
          (function (b) {
            !(function (e) {
              ...
              var r = typeof d === 'object' && d && !d.nodeType && d;
              var s = typeof c === 'object' && c && !c.nodeType && c;
              var t = typeof b === 'object' && b;
              ...
              if (
                ...
                typeof a === 'function' && typeof a.amd === 'object' && a.amd)
              )
                a('punycode', function () {
                  return u;
                });
        ...
        function (a, b, c) {
          ...
          function f(a, b) {
            for (
              ...
              (b !== !0 && d.nodeType === 1 && d.nodeName === 'SCRIPT') ||
                c.appendChild(f(d, b)),
                (d = d.nextSibling);
            return (
              a.nodeType === 1 &&
                ...
                a.nodeName === 'CANVAS'
                  ? e(a, c)
                  : (a.nodeName !== 'TEXTAREA' && a.nodeName !== 'SELECT') ||
                    (c.value = a.value)),
              c
            );
          }
        ...
        function (b, c, d) {
          function e(a, b) {
            ...
            if (
              ((b = b || {}),
              b.logging &&
                ((p.options.logging = !0), (p.options.start = Date.now())),
              (b.async = typeof b.async === 'undefined' || b.async),
              (b.allowTaint =
                typeof b.allowTaint !== 'undefined' && b.allowTaint),
              (b.removeContainer =
                typeof b.removeContainer === 'undefined' || b.removeContainer),
              (b.javascriptEnabled =
                typeof b.javascriptEnabled !== 'undefined' &&
                b.javascriptEnabled),
              (b.imageTimeout =
                typeof b.imageTimeout === 'undefined' ? 1e4 : b.imageTimeout),
              (b.renderer = typeof b.renderer === 'function' ? b.renderer : l),
              (b.strict = !!b.strict),
              typeof a === 'string')
            ) {
              if (typeof b.proxy !== 'string')
                return Promise.reject('Proxy must be used when rendering url');
              var d = b.width != null ? b.width : window.innerWidth;
              var e = b.height != null ? b.height : window.innerHeight;
          ...
          function f(a, b, c, d, e) {
            return r(
              ...
              var k = j.document.querySelector(i);
              var l =
                typeof b.onclone === 'function'
          ...
          function g(a, b, c, d, e) {
            ...
            var g = new k(f.document);
            var j = new m(c, g);
            var l = t(a);
            var o = c.type === 'view' ? d : l.right + 1;
            var q = c.type === 'view' ? e : l.bottom + 1;
            var r = new c.renderer(o, q, j, c, document);
            var s = new n(a, r, g, j, c);
            return s.ready.then(function () {
              ...
              if (c.type === 'view')
                ...
                var e = {
                  width: c.width != null ? c.width : l.width,
                  height: c.height != null ? c.height : l.height,
                  top: l.top,
                  left: l.left,
                  x: 0,
                  y: 0,
          ...
          function h(a, b) {
            b.removeContainer &&
              (a.parentNode.removeChild(a), p('Cleaned up container'));
          }
          function i(a, b) {
            var c = document.createElement('canvas');
            var d = Math.min(a.width - 1, Math.max(0, b.left));
            var e = Math.min(a.width, Math.max(1, b.left + b.width));
            var f = Math.min(a.height - 1, Math.max(0, b.top));
            var g = Math.min(a.height, Math.max(1, b.top + b.height));
          ...
          var k = b('./support');
          var l = b('./renderers/canvas');
          var m = b('./imageloader');
          var n = b('./nodeparser');
          var o = b('./nodecontainer');
          var p = b('./log');
          var q = b('./utils');
          var r = b('./clone');
          var s = b('./proxy').loadUrlDocument;
          var t = q.getBounds;
          var u = 'data-html2canvas-node';
          var v = 0;
          (e.CanvasRenderer = l),
            (e.NodeContainer = o),
            (e.log = p),
            ...
            this.promise = (
              c
                ? new Promise(function (a) {
                    b.contentWindow.document.URL === 'about:blank' ||
                    b.contentWindow.document.documentElement == null
      ...
      11: [
        function (a, b, c) {
          ...
          var e = a('./log');
          var f = a('./imagecontainer');
          var g = a('./dummyimagecontainer');
          var h = a('./proxyimagecontainer');
          var i = a('./framecontainer');
          var j = a('./svgcontainer');
          var k = a('./svgnodecontainer');
          var l = a('./lineargradientcontainer');
          var m = a('./webkitgradientcontainer');
          var n = a('./utils').bind;
          (d.prototype.findImages = function (a) {
                ...
                c.args.forEach(function (d) {
                  this.imageExists(a, d) ||
                    ...
                    e(
                      ...
                      typeof d === 'string' ? d.substring(0, 100) : d,
                    ));
                }, this);
              };
            }),
            (d.prototype.hasImageBackground = function (a) {
              return a.method !== 'none';
            }),
            (d.prototype.loadImage = function (a) {
              ...
              return a.method === 'linear-gradient'
                ? new l(a)
                : a.method === 'gradient'
                ? new m(a)
                : a.method === 'svg'
            ...
            (d.prototype.isSVG = function (a) {
              return (
                a.substring(a.length - 3).toLowerCase() === 'svg' ||
        ...
        function (a, b, c) {
          function d(a) {
            ...
            b
              ...
              this.colorStops[this.colorStops.length - 1].stop === null &&
      ...
      14: [
        function (a, b, c) {
          ...
          function g(a) {
            ...
            var g = a[5];
            var h = b * f - c * e;
            var i = [f, -e, -c, b, c * g - d * f, d * e - b * g].map(function (
              a,
            ) {
              return a / h;
            });
          ...
          var l = a('./utils');
          var m = l.getBounds;
          var n = l.parseBackgrounds;
          var o = l.offsetBounds;
          (d.prototype.cloneTo = function (a) {
            ...
            (d.prototype.parseBackgroundImages = function () {
              return (
                ...
                (this.backgroundImages = n(this.css('backgroundImage')))
              );
            }),
            (d.prototype.cssList = function (a, b) {
              ...
              return (
                (c = c[b || 0] || c[0] || 'auto'),
                (c = c.trim().split(' ')),
                c.length === 1 && (c = [c[0], h(c[0]) ? 'auto' : c[0]]),
                c
              );
            }),
            ...
            (d.prototype.parseBackgroundPosition = function (a, b, c, d) {
              var e;
              var f;
              var g = this.cssList('backgroundPosition', c);
              return (
                (e = h(g[0])
            ...
            (d.prototype.parseTransform = function () {
              if (!this.transformData)
                if (this.hasTransform()) {
                  ...
                  var b = this.prefixedCss('transformOrigin')
                    .split(' ')
                    .map(i)
                    .map(j);
                  (b[0] += a.left),
            ...
            (d.prototype.parseTransformMatrix = function () {
              if (!this.transformMatrix) {
                ...
                var b = a ? f(a.match(this.MATRIX_PROPERTY)) : null;
            ...
            (d.prototype.getValue = function () {
              ...
              return (
                ...
                a.length === 0 ? this.node.placeholder || '' : a
              );
            }),
      ...
      15: [
        function (a, b, c) {
          function d(a, b, c, d, e) {
            ...
            if (
              (e.background &&
                b.rectangle(0, 0, b.width, b.height, new V(e.background)),
            ...
            (f.visibile = f.isElementVisible()),
              ...
              (this.images = d.fetch(this.nodes.filter(C))),
                ...
                switch (g) {
                  case 0:
                    (k = a[0].width),
                      ...
                      (f.pathArgs = m(
                        {c1: [e.left, e.top], c2: [e.right, e.top]},
                        d[0],
                        d[1],
                        c.topLeft,
                        c.topRight,
                  ...
                  case 1:
                    (h = b.left + b.width - a[1].width),
                      ...
                      (f.pathArgs = m(
                        {c1: [e.right, e.top], c2: [e.right, e.bottom]},
                        d[1],
                        d[2],
                        c.topRight,
                        c.bottomRight,
                  ...
                  case 2:
                    (i = i + b.height - a[2].width),
                      ...
                      (f.pathArgs = m(
                        {c1: [e.right, e.bottom], c2: [e.left, e.bottom]},
                        d[2],
                        d[3],
                        c.bottomRight,
                        c.bottomLeft,
                  ...
                  case 3:
                    (j = a[3].width),
                      ...
                      (f.pathArgs = m(
                        {c1: [e.left, e.bottom], c2: [e.left, e.top]},
                        d[3],
                        d[0],
                        c.bottomLeft,
                        c.topLeft,
          ...
          function j(a, b, c) {
            ...
            var f = a.width;
            var g = a.height;
            var h = b[0][0] < f / 2 ? b[0][0] : f / 2;
            var j = b[0][1] < g / 2 ? b[0][1] : g / 2;
            var k = b[1][0] < f / 2 ? b[1][0] : f / 2;
            var l = b[1][1] < g / 2 ? b[1][1] : g / 2;
            var m = b[2][0] < f / 2 ? b[2][0] : f / 2;
            var n = b[2][1] < g / 2 ? b[2][1] : g / 2;
            var o = b[3][0] < f / 2 ? b[3][0] : f / 2;
            var p = b[3][1] < g / 2 ? b[3][1] : g / 2;
            var q = f - k;
            var r = g - n;
            var s = f - m;
            var t = g - p;
            return {
              topLeft: i(
                d + c[3].width / 2,
                e + c[0].width / 2,
                Math.max(0, h - c[3].width / 2),
                Math.max(0, j - c[0].width / 2),
              ).topLeft.subdivide(0.5),
              topRight: i(
                d + Math.min(q, f + c[3].width / 2),
                e + c[0].width / 2,
                q > f + c[3].width / 2 ? 0 : k - c[3].width / 2,
                l - c[0].width / 2,
              ).topRight.subdivide(0.5),
              bottomRight: i(
                d + Math.min(s, f - c[3].width / 2),
                e + Math.min(r, g + c[0].width / 2),
                Math.max(0, m - c[1].width / 2),
                n - c[2].width / 2,
              ).bottomRight.subdivide(0.5),
              bottomLeft: i(
                d + c[3].width / 2,
                e + t,
                Math.max(0, o - c[3].width / 2),
                p - c[2].width / 2,
          ...
          function m(a, b, c, d, e) {
            ...
            return (
              b[0] > 0 || b[1] > 0
                ? (f.push(['line', d[1].start.x, d[1].start.y]),
                  d[1].curveTo(f))
                : f.push(['line', a.c1[0], a.c1[1]]),
              c[0] > 0 || c[1] > 0
                ? (f.push(['line', e[0].start.x, e[0].start.y]),
                  e[0].curveTo(f))
                : f.push(['line', a.c2[0], a.c2[1]]),
              f
            );
          }
          ...
          function x(a) {
            ...
            var c =
              ['absolute', 'relative', 'fixed'].indexOf(b) !== -1
                ? a.css('zIndex')
                : 'auto';
            return c !== 'auto';
          }
          function y(a) {
            return a.css('position') !== 'static';
          }
          function z(a) {
          ...
          function A(a) {
            return (
              ['inline-block', 'inline-table'].indexOf(a.css('display')) !== -1
            );
          }
          function B(a) {
            var b = this;
          ...
          function M(a) {
            for (var b, c = [], d = 0, e = !1; a.length; )
              N(a[d]) === e
                ...
                : d++,
                d >= a.length &&
                  ((b = a.splice(0, d)), b.length && c.push(Q.ucs2.encode(b)));
            return c;
          }
          function N(a) {
          ...
          var P = a('./log');
          var Q = a('punycode');
          var R = a('./nodecontainer');
          var S = a('./textcontainer');
          var T = a('./pseudoelementcontainer');
          var U = a('./fontmetrics');
          var V = a('./color');
          var W = a('./stackingcontext');
          var X = a('./utils');
          var Y = X.bind;
          var Z = X.getBounds;
          var $ = X.parseBackgrounds;
          var _ = X.offsetBounds;
          (d.prototype.calculateOverflowClips = function () {
            this.nodes.forEach(function (a) {
              if (C(a)) {
                D(a) && a.appendToDOM(), (a.borders = this.parseBorders(a));
                var b = a.css('overflow') === 'hidden' ? [a.borders.clip] : [];
                var c = a.parseClip();
                c &&
            ...
            (d.prototype.getPseudoElements = function (a) {
              ...
              if (a.node.nodeType === Node.ELEMENT_NODE) {
                ...
                var d = this.getPseudoElement(a, ':after');
            ...
            (d.prototype.getPseudoElement = function (a, b) {
              ...
              if (
                ...
                return (g.src = $(d)[0].args[0]), [h];
              var k = document.createTextNode(d);
              return g.appendChild(k), [h, new S(k, h)];
            }),
            (d.prototype.getChildren = function (a) {
              return K(
                [].filter.call(a.node.childNodes, w).map(function (b) {
                  var c = [
                    b.nodeType === Node.TEXT_NODE ? new S(b, a) : new R(b, a),
                  ].filter(J);
            ...
            (d.prototype.parseTextBounds = function (a) {
              return function (b, c, d) {
                if (
                  ...
                  if (a.node && typeof a.node.data === 'string') {
                    var f = a.node.splitText(b.length);
                    var g = this.getWrapperBounds(
                      a.node,
            ...
            (d.prototype.parse = function (a) {
              var b = a.contexts.filter(o);
              var c = a.children.filter(C);
              var d = c.filter(B(z));
              var e = d.filter(B(y)).filter(B(r));
              var f = c.filter(B(y)).filter(z);
              var h = d.filter(B(y)).filter(r);
              var i = a.contexts.concat(d.filter(y)).filter(q);
              var j = a.children.filter(E).filter(t);
              var k = a.contexts.filter(p);
              b.concat(e)
                .concat(f)
                .concat(h)
                .concat(i)
                ...
                .forEach(function (a) {
                  this.renderQueue.push(a),
                    s(a) && (this.parse(a), this.renderQueue.push(new g()));
                }, this);
            }),
            (d.prototype.paint = function (a) {
              try {
                a instanceof g
                  ...
                  : E(a)
                  ? (D(a.parent) && a.parent.appendToDOM(),
                    this.paintText(a),
                    D(a.parent) && a.parent.cleanDOM())
                  : this.paintNode(a);
              } catch (b) {
            ...
            (d.prototype.paintNode = function (a) {
              s(a) &&
                ...
                a.node.nodeName === 'INPUT' && a.node.type === 'checkbox'
                  ? this.paintCheckbox(a)
                  : a.node.nodeName === 'INPUT' && a.node.type === 'radio'
                  ? this.paintRadio(a)
                  : this.paintElement(a);
            }),
                    ...
                    switch (a.node.nodeName) {
                      ...
                      case 'IMG':
                        ...
                        d
                          ...
                          : P('Error loading <img>', a.node.src);
                        break;
                      case 'CANVAS':
            ...
            (d.prototype.paintCheckbox = function (a) {
              ...
              var d = {width: c - 1, height: c - 1, top: b.top, left: b.left};
              var e = [3, 3];
              var f = [e, e, e, e];
              var g = [1, 1, 1, 1].map(function (a) {
            ...
            (d.prototype.paintRadio = function (a) {
              var b = a.parseBounds();
              var c = Math.min(b.width, b.height) - 2;
              this.renderer.clip(
                a.backgroundClip,
                function () {
            ...
            (d.prototype.paintFormValue = function (a) {
              ...
              if (b.length > 0) {
                ...
                var d = c.createElement('html2canvaswrapper');
                var e = [
                  'lineHeight',
                  'textAlign',
                  'fontFamily',
                ...
                (d.style.position = 'fixed'),
                  ...
                  this.paintText(new S(d.firstChild, a)),
            ...
            (d.prototype.paintText = function (a) {
              ...
              var c =
                (!this.options.letterRendering || u(a)) && !O(a.node.data);
              var d = c
                ? M(b)
                : b.map(function (a) {
              ...
              var f = a.parent.css('fontSize');
              var g = a.parent.css('fontFamily');
              var h = a.parent.parseTextShadows();
              this.renderer.font(
                ...
                this.renderer.clip(
                  a.parent.clip,
                  function () {
                    d.map(this.parseTextBounds(a), this).forEach(function (
                      b,
                      c,
                    ) {
                      b &&
                        ...
                        this.renderTextDecoration(
                          a.parent,
                          b,
                          this.fontMetrics.getMetrics(g, f),
                        ));
                    },
                    this);
                  },
          ...
          (d.prototype.parseBorders = function (a) {
            var b = a.parseBounds();
            var c = v(a);
            var d = ['Top', 'Right', 'Bottom', 'Left'].map(function (b, c) {
              var d = a.css('border' + b + 'Style');
              var e = a.color('border' + b + 'Color');
              d === 'inset' && e.isBlack() && (e = new V([255, 255, 255, e.a]));
      ...
      19: [
        function (a, b, c) {
          ...
          (d.prototype.renderImage = function (a, b, c, d) {
            ...
            var f = a.cssInt('paddingTop');
            var g = a.cssInt('paddingRight');
            var h = a.cssInt('paddingBottom');
            var i = c.borders;
            var j = b.width - (i[1].width + i[3].width + e + g);
            var k = b.height - (i[0].width + i[2].width + f + h);
            this.drawImage(
              d,
              0,
              0,
            ...
            (d.prototype.renderBorder = function (a) {
              if (!a.color.isTransparent() && a.args !== null)
                if (a.style === 'dashed' || a.style === 'dotted') {
                  var b = a.style === 'dashed' ? 3 : a.width;
            ...
            (d.prototype.renderBackgroundRepeating = function (a, b, c, d, e) {
              ...
              var g = a.parseBackgroundPosition(b, c.image, d, f);
              var h = a.parseBackgroundRepeat(d);
              switch (h) {
                case 'repeat-x':
        ...
        function (a, b, c) {
          ...
          (d.prototype = Object.create(f.prototype)),
              ...
              return (
                ...
                a.forEach(function (a, b) {
                  a[0] === 'rect'
                    ...
                    : this.ctx[b === 0 ? 'moveTo' : a[0] + 'To'].apply(
                        this.ctx,
                        a.slice(1),
                      );
                }, this),
            ...
            (d.prototype.renderBackgroundRepeat = function (a, b, c, d, e, f) {
              ...
              var h = Math.round(d.top + b.top + f);
              this.setFillStyle(
        ...
        function (a, b, c) {
          ...
          (d.prototype.hasFabric = function () {
            ...
            (d.prototype.decode64 = function (a) {
              return typeof window.atob === 'function' ? window.atob(a) : f(a);
            }),
            (b.exports = d);
        },
        {'./utils': 26, './xhr': 28},
          ...
          (c.smallImage = function () {
            ...
            (c.getBounds = function (a) {
              if (a.getBoundingClientRect) {
                ...
                var c = a.offsetWidth == null ? b.width : a.offsetWidth;
                return {
                  top: b.top,
                  ...
                  left: b.left,
                  width: c,
                  height: a.offsetHeight == null ? b.height : a.offsetHeight,
                };
              }
              return {};
            }),
                ...
                a.split('').forEach(function (a) {
                  if (!(k === 0 && i.indexOf(a) > -1)) {
                    switch (a) {
                      ...
                      case '(':
                        if (g) break;
                        if (k === 0) return (k = 1), void (f += a);
                        l++;
                        break;
                      case ')':
                        if (g) break;
                        if (k === 1) {
                          if (l === 0) return (k = 0), (f += a), void m();
                          l--;
                        }
                        break;
                      case ',':
                        if (g) break;
                        if (k === 0) return void m();
                        if (k === 1 && l === 0 && !b.match(/^url$/i))
        ...
        function (a, b, c) {
          function d(a) {
            e.apply(this, arguments),
              (this.type =
                a.args[0] === 'linear' ? e.TYPES.LINEAR : e.TYPES.RADIAL);
          }
          var e = a('./gradientcontainer');
          (d.prototype = Object.create(e.prototype)), (b.exports = d);
        },
